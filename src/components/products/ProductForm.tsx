    ...
    const handleBarcodeLookup = async (barcode: string) => {
        ...
        try {
            ...
            if (existingProduct) {
                ...
                // New product - Clear form and set new barcode
                setFormData({
                    name: '',
                    sku: '',
                    barcode: barcode,
                ...
                setScanHistory(prev => [{
                    ...
                    status: 'new' as const,
                    count: totalNewScans,
                    isLowStock: false // New products start at 0 stock usually, but we don't know threshold yet
                }, ...prev]);
            }
        } catch (error) {
            ...
            <div className="flex-1">
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex items-center justify-end gap-3 pt-2">
                        ...
                        >
                            {loading ? 'Saving...' : (isEditingExisting ? 'Update Product' : 'Create Product')}
                        </Button>
                    </div>
                </form>
            </div>
